...
import { FaYinYang, FaKeyboard, FaBroom, FaCogs, FaHashtag, FaClock, FaFolder, FaFile, FaTimes } from 'react-icons/fa';
  ...
  return (
    <table className={styles['settings']}>
      ...
      <tbody>
        ...
        {showAdvancedSettings && (
          <Row>
            <KeyCell>{t('Allow multiple instances of KICKO TrimOut to run concurrently? (experimental)')}</KeyCell>
            <td>
